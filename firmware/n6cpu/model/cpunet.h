/**
  ...
  ******************************************************************************
  */
#ifndef STAI_CPUNET_H
#define STAI_CPUNET_H
...
#define STAI_CPUNET_ORIGIN_MODEL_NAME         "can_h64_int8"
#define STAI_CPUNET_ORIGIN_MODEL_SIGNATURE    "0xa6a15517222aff0db762d65b7a4a425e"

/*  Generated model name and signature  */
#define STAI_CPUNET_MODEL_NAME                "cpunet"
#define STAI_CPUNET_MODEL_SIGNATURE           (0x1ffe528fe7f40a89)


/*****************************************************************************/
/*  Macros to declare network context size and required alignment  */
#define STAI_CPUNET_CONTEXT_ALIGNMENT   8
#define STAI_CPUNET_CONTEXT_SIZE        (sizeof(_stai_cpunet_context))

/*  Macro to declare network flags  */
#define STAI_CPUNET_FLAGS               (STAI_FLAG_INPUTS|STAI_FLAG_OUTPUTS|STAI_FLAG_WEIGHTS)

/*  Macro to declare number of network C nodes generated  */
#define STAI_CPUNET_NODES_NUM           (4)

/*  Macro to declare number macc for generated network model  */
#define STAI_CPUNET_MACC_NUM            (7173)

/*  Macros to declare input buffers characteristics  */
#define STAI_CPUNET_IN_NUM              (1)
#define STAI_CPUNET_IN_SIZE_BYTES       (16)

#define STAI_CPUNET_IN_ALIGNMENTS \
  { 4}
#define STAI_CPUNET_IN_NAMES \
  { NULL}
#define STAI_CPUNET_IN_FORMATS \
  { STAI_FORMAT_S8}
#define STAI_CPUNET_IN_SIZES \
  {11}
#define STAI_CPUNET_IN_SIZES_BYTES \
  {11}

#define STAI_CPUNET_IN_1_ALIGNMENT   4
#define STAI_CPUNET_IN_1_NAME        (NULL)
#define STAI_CPUNET_IN_1_FLAGS       (STAI_FLAG_INPUTS|STAI_FLAG_PREALLOCATED|STAI_FLAG_CHANNEL_LAST|STAI_FLAG_HAS_BATCH)
#define STAI_CPUNET_IN_1_FORMAT      (STAI_FORMAT_S8)
#define STAI_CPUNET_IN_1_SHAPE       {1,11}
#define STAI_CPUNET_IN_1_BATCH       (1)
#define STAI_CPUNET_IN_1_CHANNEL     (11)
#define STAI_CPUNET_IN_1_RANK        (1)
#define STAI_CPUNET_IN_1_SIZE        (11)
#define STAI_CPUNET_IN_1_SIZE_BYTES  (11)
#define STAI_CPUNET_IN_1_SCALE       (0.024639930576086044f)
#define STAI_CPUNET_IN_1_ZERO_POINT  (4)

/*****************************************************************************/
/*  Macros to declare output buffers characteristics  */
#define STAI_CPUNET_OUT_NUM             (1)
#define STAI_CPUNET_OUT_SIZE_BYTES      (12)
#define STAI_CPUNET_OUT_ALIGNMENTS \
  { 4}
#define STAI_CPUNET_OUT_NAMES \
  { NULL}
#define STAI_CPUNET_OUT_FORMATS \
  { STAI_FORMAT_S8}
#define STAI_CPUNET_OUT_SIZES \
  { 5}
#define STAI_CPUNET_OUT_SIZES_BYTES \
  {5}

#define STAI_CPUNET_OUT_1_ALIGNMENT   4
#define STAI_CPUNET_OUT_1_NAME        (NULL)
#define STAI_CPUNET_OUT_1_FLAGS       (STAI_FLAG_OUTPUTS|STAI_FLAG_PREALLOCATED|STAI_FLAG_CHANNEL_LAST|STAI_FLAG_HAS_BATCH)
#define STAI_CPUNET_OUT_1_FORMAT      (STAI_FORMAT_S8)
#define STAI_CPUNET_OUT_1_SHAPE       {1,5}
#define STAI_CPUNET_OUT_1_BATCH       (1)
#define STAI_CPUNET_OUT_1_CHANNEL     (5)
#define STAI_CPUNET_OUT_1_RANK        (1)
#define STAI_CPUNET_OUT_1_SIZE        ((5))
#define STAI_CPUNET_OUT_1_SIZE_BYTES  (5)
#define STAI_CPUNET_OUT_1_SCALE       (0.0012466589687392116f)
#define STAI_CPUNET_OUT_1_ZERO_POINT  (36)

/*****************************************************************************/
/*  Macros to declare activations buffers characteristics  */
#define STAI_CPUNET_ACTIVATIONS_SIZE              (384)
#define STAI_CPUNET_ACTIVATIONS_SIZE_BYTES        (384)
#define STAI_CPUNET_ACTIVATIONS_ALIGNMENTS \
  { 4}
#define STAI_CPUNET_ACTIVATIONS_SIZES \
  { 384}
#define STAI_CPUNET_ACTIVATIONS_NUM               (1)

#define STAI_CPUNET_ACTIVATION_1_FLAGS      (STAI_FLAG_ACTIVATIONS)
#define STAI_CPUNET_ACTIVATION_1_SIZE       (384)
#define STAI_CPUNET_ACTIVATION_1_SIZE_BYTES (384)
#define STAI_CPUNET_ACTIVATION_1_ALIGNMENT  4
/*  Macros to declare weights buffers characteristics  */

#define STAI_CPUNET_WEIGHTS_NUM                  (1)
#define STAI_CPUNET_WEIGHTS_SIZE                  (7668)
#define STAI_CPUNET_WEIGHTS_SIZE_BYTES            (7668)
#define STAI_CPUNET_WEIGHTS_ALIGNMENTS \
  { 4}
#define STAI_CPUNET_WEIGHTS_SIZES \
  { 7668}
#define STAI_CPUNET_WEIGHTS_NUM        (1)
#define STAI_CPUNET_WEIGHT_1_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_CPUNET_WEIGHT_1_SIZE        (7668)
#define STAI_CPUNET_WEIGHT_1_SIZE_BYTES  (7668)


/*****************************************************************************/
/*  Macros to declare states buffers characteristics  */
#define STAI_CPUNET_STATES_SIZE              (0)
#define STAI_CPUNET_STATES_SIZE_BYTES        (0)
#define STAI_CPUNET_STATES_ALIGNMENTS        {}
#define STAI_CPUNET_STATES_SIZES             { 0, }
#define STAI_CPUNET_STATES_NUM               (0)

#define STAI_CPUNET_STATE_1_FLAGS            (0x0)
#define STAI_CPUNET_STATE_1_ALIGNMENT        4
#define STAI_CPUNET_STATE_1_SIZE             (0)
#define STAI_CPUNET_STATE_1_SIZE_BYTES       (0)
/*****************************************************************************/
...
typedef struct {
  ...
  stai_ptr                     _activations[STAI_CPUNET_ACTIVATIONS_NUM];
  stai_ptr                     _weights[STAI_CPUNET_WEIGHTS_NUM];
  stai_ptr                     _inputs[STAI_CPUNET_IN_NUM];
  stai_ptr                     _outputs[STAI_CPUNET_OUT_NUM];
} _stai_cpunet_context;
 ...
 *          @ref STAI_CPUNET_CONTEXT_SIZE or @ref stai_cpunet_get_context_size(void) API
 ...
 *          on the input buffers whose memory adresses are retrived using @ref stai_cpunet_get_inputs() API.
 *          Alternatively the application could allocate the inputs and set the addresses using the
 *          @ref stai_cpunet_set_inputs() API. Similar behaviour is expected for the network outputs handling.
 *          The features of each input / output buffer (format, byte size, etc.)may be queried using
 *          @ref stai_cpunet_get_info() API or the set of specific macros available in this header file.
 ...
 *          @ref stai_cpunet_get_outputs() API.
 * @param[in] network network context opaque pointer
 ...
 */
STAI_API_ENTRY
stai_size stai_cpunet_get_context_size(void);
 ...
 *          @ref stai_cpunet_set_states() dual API
 * @param[in] network network context opaque pointer
 ...
 *          @ref stai_cpunet_run() API. It is a helper routine that could be used by an application for debug
