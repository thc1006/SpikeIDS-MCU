...
deployment on an ARM Cortex-M NPU and the first publicly documented
non-vision workload on the Neural-ART accelerator.
\end{abstract}
...
Separately, several GPU-based SNN-IDS systems have been proposed:
...
(R2L: 995 train / 2,754 test; U2R: 52 train / 200 test).
