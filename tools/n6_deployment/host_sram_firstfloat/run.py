"""SM04 fixed first-layer semantic-repair bundle. Default offline; explicit bounded RAM only."""
import argparse
import hashlib
...
BUILD=HERE.parent/'firmware_sram_firstfloat/build_actual_01'
SOURCE_PINS={
...
BUILD_PINS={
    'RESULT.json':'6ba56223fbd8ee055d02cf149df9cb0ff53039789b44a4c224eb1b6d94ce9a1b',
    'n6_sram.elf':'dbd51b7de4a1a09b5507e9876d72c12dba0c55e67672749f5f68a353e9ee4dc7',
}
...
def bindings():
    old=frozen('run.py','_sm04_original_launcher')
    ...
    rp=frozen('runtime_protocol.py','_sm04_wire')
    ...
    try:
        ...
        controller=frozen('controller.py','_sm04_controller')
    finally:
...
def main(argv=None):
    ...
    sink.json('INTENT.json',dict(kind='SM04_first_layer_semantic_repair_full_validation',sources=pins,
