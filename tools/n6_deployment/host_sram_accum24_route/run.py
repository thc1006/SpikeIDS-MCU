"""SM06 fixed accumulator candidate. Default offline; explicit INIT-ONLY RAM diagnostic."""
import argparse
import hashlib
...
def main(argv=None):
    ...
    sink.json('INTENT.json',dict(kind='SM06_INIT_ONLY_not_inference_or_acceptance',sources=pins,
