...
ENGINE=HERE.parent/'host_sram_accum24/diagnostic_engine.py'
ENGINE_SHA='b7423d6f023039beea7748a2838b87609e8c0530004ee83a328a9ee65e3c1530'
PREVIOUS=HERE.parents[2]/'results/n6_sram_init_20260926_07/final_mailbox.bin'
PREVIOUS_SHA='90ee5c07fe1b02920b08aacdb654d5c9fdd93d8161d9393b6450f258673dbd4e'
...
def engine(rp):
    ...
    spec=importlib.util.spec_from_file_location('_sm06_observer',ENGINE);m=importlib.util.module_from_spec(spec)
...
def main():
    ...
    sink.json('INTENT.json',dict(kind='SM06_one_row_NPU_accumulator_diagnostic_not_acceptance',sources=pins,
