"""Independent saved NumPy/struct review of SM03; no board or producer imports."""
import argparse
import hashlib
import json
...
def review(directory):
    ...
    require(intent['kind']=='SM03_fixed_QDQ_compatibility_full_validation' and intent['deployment_tag']==0x534d3033,'Wrong intent')
    ...
    for i,name in enumerate(names):
        ...
        require(w[:4]==(0x53364e36,1,512,5) and w[31]==0x534d3033,'Wrong firmware/state')
